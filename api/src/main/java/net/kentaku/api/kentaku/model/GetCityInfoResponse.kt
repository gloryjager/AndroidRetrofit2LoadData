...
data class GetCityInfoResponse(
  ...
  data class CityInfoItem(
      ...
      val nurseryschool: Int,
      @Json(
          name = "nurseryschool_u0"
      )
      val nurseryschoolU0: Int,
      @Json(
          name = "private_nurseryschool"
      )
      val privateNurseryschool: Int,
      @Json(
          name = "private_nurseryschool_u0"
      )
      val privateNurseryschoolU0: Int,
      @Json(
          name = "wating_child"
      )
      val watingChild: Int,
      ...
      val kindergartenPub: Int,
      @Json(
          name = "kindergarten_pro"
      )
      val kindergartenPro: Int,
      @Json(
          name = "elementaryschool_num"
      )
      val elementaryschoolNum: Int,
      @Json(
          name = "juniorhighscool_num"
      )
      val juniorhighscoolNum: Int,
      @Json(
          name = "hospital_num"
      )
      val hospitalNum: Int,
